    ...
    <nav className=''>
      <div>
        ...
        <nav className='shadow-md bg-white dark:bg-slate-900 dark:text-white duration-300 relative z-40'>
          <div className='container flex items-center justify-between bg-primary/40 py-2'>
            {/* logo */}
            <div className=''>
              <a
                href=''
            ...
            <div className='group relative sm:block'>
              <input
                ...
                className='w-[200px] sm:w-[200px] group-hover:w-[300px] transition-all duration-300 rounded-full border px-2 py-1 border-gray-500 focus:outline-none focus:border-1 focus:border-primary'
              />
