    ...
    <div className='header'>
      <div className='header-container'>
        ...
        <div className='header-search'>
          ...
          <div onClick={handlePicker} className='header-search-item'>
          ...
          <div className='header-search-item' onClick={handleOpenOptionDialog}>
              ...
              <div className='options-dialog'>
                <div className='option-item'>
                  ...
                  <div className='option-counter'>
                    <button
                      ...
                      onClick={() => handleOptionButton('adults', 'increase')}
                    >
                      +
                    </button>
                    <span>{options.adults}</span>
                    <button
                      onClick={() => handleOptionButton('adults', 'decrease')}
                      className='option-counter-button'
                    >
                      -
                    </button>
                ...
                <div className='option-item'>
                  ...
                  <div className='option-counter'>
                    <button
                      className='option-counter-button'
                      onClick={() => handleOptionButton('children', 'increase')}
                    >
                      +
                    </button>
                    <span>1</span>
                    <button
                      className='option-counter-button'
                      onClick={() => handleOptionButton('children', 'decrease')}
                    >
                      -
                    </button>
                  </div>
